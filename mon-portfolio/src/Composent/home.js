                                ...
                                <div className="content-inner">
                                    ...
                                    <div className="widget-search">
                                        <div className="widget">
                                            <form action="https://formspree.io/f/myyleorq" method="POST">
                                                <input id="search2" type="text" name="s" placeholder="Search Product" title="Search for:" autoComplete="off" />
                                    ...
                                    <div className="product-category">
                                        ...
                                        <ul className="list-style-one">
                                            <li><Link to="shop-2.html">IT Solutions<span>(5)</span></Link></li>
                                            <li><Link to="shop-2.html">Businesses<span>(6)</span></Link></li>
                                            <li><Link to="shop-2.html">IT Service<span>(4)</span></Link></li>
                                            <li><Link to="shop-2.html">UI/UX Design<span>(8)</span></Link></li>
                                        </ul>
                                    </div>
                                    {/* Recent Gallery */}
                                        ...
                                        <ul>
                                            <li>
                                                <div className="widget-gallery-thumb">
                                                    <Link to="#"><img src="assets/images/inner/recent-post.png" alt="" /></Link>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="widget-gallery-thumb">
                                                    <Link to="#"><img src="assets/images/inner/recent-post2.png" alt="" /></Link>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="widget-gallery-thumb">
                                                    <Link to="#"><img src="assets/images/inner/recent-post3.png" alt="" /></Link>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="widget-gallery-thumb">
                                                    <Link to="#"><img src="assets/images/inner/recent-post4.png" alt="" /></Link>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="widget-gallery-thumb">
                        ...
                        <div className="row hero align-items-center">
                            <div className="col-lg-5 col-md-7">
                                <div className="hero-contant">
                                    ...
                                    <p>We have been operating for over a decade providing exceptional services.</p>
                                    <div className="solutek-btn">
                                        <Link to="about-us.html" className="btn-2">Get Started</Link>
                                    </div>
                                    <div className="hero-btn-3">
                                        <div className="hero-btn-profile">
                                            <img src="assets/images/home-3/hero-pro.png" alt="img" />
                                            <Link to="about-us.html"><span>MEET</span> Our Experts</Link>
                                        </div>
                                    </div>
                            ...
                            <div className="service-box">
                                <div className="single-service-box">
                                    ...
                                    <div className="service-box-content">
                                        <h4 className="service-title"><Link to="service-details.html">Web Development</Link></h4>
                                        <p className="service-desc">Success professional development our solutions maximize creative services.</p>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="service-box">
                                <div className="single-service-box">
                                    ...
                                    <div className="service-box-content">
                                        <h4 className="service-title"><Link to="service-details.html">Digital Marketing</Link></h4>
                                        <p className="service-desc">Success professional development our solutions maximize creative services.</p>
                                    </div>
                                </div>
                                <div className="service-thumb">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="service-box">
                                <div className="single-service-box">
                                    ...
                                    <div className="service-box-content">
                                        <h4 className="service-title"><Link to="service-details.html">App Development</Link></h4>
                                        <p className="service-desc">Success professional development our solutions maximize creative services.</p>
                                    </div>
                                </div>
                                <div className="service-thumb">
                        ...
                        <div className="col-lg-6">
                            <div className="about-contact">
                                <div className="section-title text-left">
                                    ...
                                    <p className="section-title-descr">Solution is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                                ...
                                <div className="solutek-btn">
                                    <Link to="about-us.html">EXPLORE MORE
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-case-studies-box">
                                        <div className="case-studies-content">
                                            <h4><Link to="project-details.html">Travel & Tour Mobile Apps Design</Link></h4>
                            ...
                            <div className="case-studies-single-box">
                                <div className="case-studies-thumb">
                                    ...
                                    <div className="case-studie-content">
                                        <h3><Link to="project-details.html">Professional Website Design</Link></h3>
                                        <h6>Web Design</h6>
                                    </div>
                        ...
                        <div className="col-lg-6">
                            <div className="case-studies-single-box">
                                <div className="case-studies-thumb">
                                    ...
                                    <div className="case-studie-content">
                                        <h3><Link to="project-details.html">E-commerce Platform Development</Link></h3>
                                        <h6>E-commerce</h6>
                                    </div>
                                    <div className="case-studies-icon">
                                        <i className="bi bi-arrow-right"></i>
                    ...
                    <div className="row">
                        <div className="col-lg-5">
                            <div className="section-title text-left">
                                ...
                                <h1 className="section-main-title">Customized Solutions to</h1>
                                <h1 className="section-main-title">Meet Client <span>Needs.</span></h1>
                                <p>Solution is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                            </div>
                            <div className="testi-thumb">
                                <img src="assets/images/home-3/test-thumb.png" alt="thumb" />
                                <div className="testi-autor">
                                    <h4 className="testi-user-name">Brandon A. Vela <span>UI Designer</span></h4>
                                </div>
                                                    ...
                                                    <div className="testi-box">
                                                        <div className="testimonial-single-box">
                                                            ...
                                                            <div className="testi-text">
                                                                <p className="testi-desc">Proactively whiteboard one-to-one total linkage for multimedia based ideas synergistically evolve.</p>
                                                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="working-process-box before-transprent after-transprent">
                                ...
                                <div className="process-content">
                                    ...
                                    <p>Solution is a long established process that helps in planning and researching effectively.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="working-process-box after-transprent">
                                ...
                                <div className="process-content">
                                    ...
                                    <p>This step involves creating designs and prototypes that meet client needs.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="working-process-box before-transprent">
                                ...
                                <div className="process-content">
                                    ...
                                    <p>We deliver the final solution that meets all requirements and expectations.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <div className="section-title text-left">
                                <h6 className="section-sub-title">client review</h6>
                                <h1 className="section-main-title">Most Common <span>Questions?</span></h1>
                            </div>
                            <div className="tab_container">
                                <div id="tab1" className="tab_content">
                                    <ul className="accordion">
                                        <li>
                                            <a><span>What Medical Services Do You Provide?</span></a>
                                            <p style={{ display: 'none' }}>We provide a wide range of medical services tailored to client needs.</p>
                                        </li>
                                        <li>
                                            <a><span>What is your customer geography?</span></a>
                                            <p>Our services cater to various geographical locations with a focus on accessibility.</p>
                                        </li>
                                        <li>
                                            <a><span>What are the main industries we serve?</span></a>
                                            <p>We serve multiple industries, ensuring innovative solutions for every sector.</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="single-blog-box">
                                ...
                                <div className="blog-box-content">
                                    <div className="meta-blog">
                                        <Link to="blog-details.html"><span><i className="far fa-user"></i>HOSSAIN ASIF</span></Link>
                                        <p><span><img src="assets/images/home-two/mesage-icon.png" alt="icon" /></span>COMMENTS</p>
                                    </div>
                                    <h3><Link to="blog-details.html">Regional Manager Limited Time Management</Link></h3>
                                    <div className="blog-button">
                                        <Link className="btn-2" to="blog.html">read post</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-box">
                                ...
                                <div className="blog-box-content">
                                    ...
                                    <h3><Link to="blog-details.html">The Complete Guide to Tekone App Development</Link></h3>
                                    <div className="blog-button">
                                        <Link className="btn-2" to="blog.html">read post</Link>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog-box">
                                ...
                                <div className="blog-box-content">
                                    ...
                                    <h3><Link to="blog-details.html">Easy and Most Powerful Server and Platform</Link></h3>
                                    <div className="blog-button">
                                        <Link className="btn-2" to="blog.html">read post</Link>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="address-box2">
                                ...
                                <div className="solutek-btn">
                                    <Link to="contact.html">+44 920 090 505
                                        <div className="solutek-hover-btn hover-bx"></div>
                                        <div className="solutek-hover-btn hover-bx2"></div>
                                        <div className="solutek-hover-btn hover-bx3"></div>
                                        <div className="solutek-hover-btn hover-bx4"></div>
